...
<ol class="breadcrumb bg-success">
  <li class="breadcrumb-item text-dark">Converting : &nbsp;&nbsp;&nbsp;&nbsp; <strong id="con-date">Last date loaded : loading</strong></li>
  <li class="breadcrumb-item text-dark"><strong id="con-status">loading status</strong></li>
</ol>
